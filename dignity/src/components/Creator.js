    ...
    return (
        <div style={{textAlign: 'center'}}>
            ...
            <div style={centerStyle}>
                <iframe src="https://docs.google.com/forms/d/e/1FAIpQLSep7FNKzVVquhesfR1LmgIJ6bHUr4YTwJtZ7dFEOPu8gE7cEw/viewform?embedded=true" width="640" height="2050" frameborder="0" marginheight="0" marginwidth="0">Loading…</iframe>
            </div>
        </div>
    )
