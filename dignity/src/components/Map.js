...
export function Map({ loggedIn, selectedPage, showSignIn, setShowSignIn }) {
  ...
  return (
    ...
    >
      {markers.map(({ id, Organization_Name, Opportunity_Type, Start_Date, Address, Volunteers, Virtual }) => (
        <MarkerF
          key={id}
          position={center}
